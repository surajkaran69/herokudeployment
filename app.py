...
def main():
    ...
    p= ""
    if st.button("Result"):
        p=worker_prediction([Age,Activity_Category,StdWorkingHrsPerDay,Pulse_rate_in_idle,Average_Pulse_rate_in_activity,Calories_Burnt_per_shift,TargetedWorkPerWorkingDay,Actual_Workdone_when_using_fitbit])
    st.success(p)
