...
import pickle
loaded_model = pickle.load(open(r"knn.pkl","rb"))
...
def main():
    ...
    p= ""
    if st.button("Result"):
        p=worker_prediction([Age,Activity_Category,StdWorkingHrsPerDay,Pulse_rate_in_idle,Average_Pulse_rate_in_activity,Calories_Burnt_per_shift,TargetedWorkPerWorkingDay])
    st.success(p)
